...
import 'package:Testing2/data/dactor_model.dart';
import 'package:Testing2/data/data.dart';
...
class MenuContaint extends StatefulWidget {
  MenuContaint({Key key}) : super(key: key);


  @override
  _MenuContaint createState() => _MenuContaint();
}

class _MenuContaint extends State<MenuContaint> {
